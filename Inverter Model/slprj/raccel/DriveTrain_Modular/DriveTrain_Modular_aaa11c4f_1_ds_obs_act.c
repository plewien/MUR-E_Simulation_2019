...
int32_T DriveTrain_Modular_aaa11c4f_1_ds_obs_act ( const NeDynamicSystem *
sys , const NeDynamicSystemInput * t31 , NeDsMethodOutput * t32 ) {
PmRealVector out ; real_T Accumulator_Simple_Battery_p_v ; real_T
...
t32 -> mOBS_ACT ; Accumulator_Simple_Battery_p_v = X_idx_9 * 0.001 + 48.0 ;
